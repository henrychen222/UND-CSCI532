...
void initialize_opencl(int z, int y, int x) {
    ...
    // Build program
    matrix_add_program = build_program(context, device, MATRIX_ADD_KERNEL_FILE);

    // Create a kernel
    kernel = clCreateKernel(matrix_add_program, "matrix_add", &err);
